...
def register_ldbc_datasets() -> None:
    ...
    """
    # Register loader (idempotent - ignore if already registered)
    try:
    ...
    if "ldbc-snb-sf0.001" not in _DATASET_REGISTRY:
        register_dataset(
            DatasetInfo(
    ...
    # LDBC SNB SF0.1
    if "ldbc-snb-sf0.1" not in _DATASET_REGISTRY:
        register_dataset(
            DatasetInfo(
                name="ldbc-snb-sf0.1",
    ...
    # LDBC SNB SF1
    if "ldbc-snb-sf1" not in _DATASET_REGISTRY:
        register_dataset(
            DatasetInfo(
                name="ldbc-snb-sf1",
    ...
    # LDBC SNB SF10
    if "ldbc-snb-sf10" not in _DATASET_REGISTRY:
        register_dataset(
            DatasetInfo(
                name="ldbc-snb-sf10",
